import { Editor } from '/js/vendor/tiptap-core.js'
import StarterKit from '/js/vendor/tiptap-starter-kit.js'
import BubbleMenu from '/js/vendor/tiptap-extension-bubble-menu.js'
import Placeholder from '/js/vendor/tiptap-extension-placeholder.js'
import Link from '/js/vendor/tiptap-extension-link.js'
import Image from '/js/vendor/tiptap-extension-image.js'
import { Markdown } from '/js/vendor/tiptap-markdown.js'
import TaskList from '/js/vendor/tiptap-extension-task-list.js'
import TaskItem from '/js/vendor/tiptap-extension-task-item.js'
import Table from '/js/vendor/tiptap-extension-table.js'
import TableRow from '/js/vendor/tiptap-extension-table-row.js'
import TableHeader from '/js/vendor/tiptap-extension-table-header.js'
import TableCell from '/js/vendor/tiptap-extension-table-cell.js'
